...
export async function GET(req: NextRequest) {
    try {
        ...
        let query = supabase.from('tax_authorities').select('*');
        if (searchParams.has('country_id')) query = query.eq('country_id', searchParams.get('country_id'));
